                    ...
                    {filteredCourses.map((course) => (
                        ...
                        >
                            <div className={`relative ${viewMode === 'list' ? 'sm:w-[350px] shrink-0' : 'aspect-video'}`}>
                                ...
                                <div className="absolute bottom-4 right-4 bg-indigo-500 px-4 py-1.5 rounded-full text-sm font-black text-white shadow-lg">
                                    ${course.price}
                                </div>
                            </div>
                            ...
                            <div className="p-8 flex flex-col justify-between flex-1">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center justify-between pt-2">
                                        ...
                                        <div className="text-indigo-400 font-bold text-sm flex items-center gap-1 group-hover:gap-2 transition-all">
